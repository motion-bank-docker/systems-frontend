<template lang="pug">
  div
    div.kachel-wrap
      a(@click="$router.push({ name: 'piecemaker.listVideos' })")
        div.kachel My Videos
    div.kachel-wrap
      a(@click="$router.push({ name: 'piecemaker.listPrivate' })")
        div.kachel Alle eigenen Gruppen
      a(@click="$router.push({ name: 'piecemaker.listGroups' })")
        div.kachel Alle Gruppen, in denen ich Mitglied bin
      a(@click="$router.push({ name: 'piecemaker.listAllPublic' })")
