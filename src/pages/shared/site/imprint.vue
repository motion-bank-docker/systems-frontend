  ...
  full-screen
    .row
      .col-xs-12.col-xs-10.col-sm-8
        h5.q-mb-md.q-mt-none  Impressum
        p.q-mb-xs MOTION BANK
      ...
      .col-xs-12.col-xs-10.col-sm-8
        h5.q-mb-md Profile
        p.q-mb-xs Projekt, Konzeption und Gestaltung
        p Prof. Florian Jenett

      .col-xs-12.col-xs-10.col-sm-8
        h5.q-mb-md Umsatzst.-Id-Nr.
        p DE 149 065 597

      .col-xs-12.col-xs-10.col-sm-8
        h5.q-mb-md Gesetzlicher Vertreter
        p Präsident der Hochschule, Prof. Dr.-Ing. Gerhard Muth

      .col-xs-12.col-xs-10.col-sm-8
        h5.q-mb-md Zuständige Aufsichtsbehörde
        p.q-mb-xs Ministerium für Wissenschaft
        p.q-mb-xs Weiterbildung und Kultur des Landes Rheinland-Pfalz
        p.q-mb-xs Mittlere Bleiche 61
        p 55116 Mainz

      .col-xs-12.col-xs-10.col-sm-8
        h5.q-mb-md Verantwortliche I. S. D. § 55 ABS. 2 RFSTV
        p Prof. Dr.-Ing. Gerhard Muth

      .col-xs-12.col-xs-10.col-sm-8
        h5.q-mb-md Copyright
        p Hochschule Mainz, Studiengang Kommunikationsdesign sowie die Autoren von Text und Bild.
